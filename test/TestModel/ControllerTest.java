...
public class ControllerTest {
    ...
    public void testInputCase1() throws IOException {
        ...
        List<String> inputSetLines = Files.readAllLines(Paths.get("test_case/case_1.txt"));
    ...
    public void testInputCase2() throws IOException {
        ...
        // Read the input set from the file
        List<String> inputSetLines = Files.readAllLines(Paths.get("test_case/case_2.txt"));
    ...
    public void testInputCase3() throws IOException {
        ...
        // Read the input set from the file
        List<String> inputSetLines = Files.readAllLines(Paths.get("test_case/case_3.txt"));
